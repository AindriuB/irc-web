...
| 2026-09-24 | 01, 04 | irc-web pinned to irc-client 1.2.1 with credential-free error mapping; app.js shows a warn-coloured reconnecting state that disables input/Say and re-enables Connect after gave-up | ## 2026-09-24 — irc-client 1.2.1 is live, and the UI has a reconnecting state |
| 2026-09-24 | 02 | A failed registration now leads with the server's own scrubbed NOTICE/ERROR text ahead of the fixed reason, e.g. "Twitch said: Login unsuccessful" | ## 2026-09-24 — A failed registration now shows the server's own words |
| 2026-09-24 | 03 | Browser now shows live reconnecting/gave-up status from irc-client 1.2.1's connection events; production retries ~2h (1s/300s/32 attempts) before giving up | ## 2026-09-24 — Reconnecting and gave-up now reach the browser live |
